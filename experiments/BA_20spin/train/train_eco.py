...
# 设置新的工作目录
new_working_directory = "C:/Users/Gong Zhongben/Desktop/eco-dqn-master - 副本"
os.chdir(new_working_directory)

# 再次获取并打印当前工作目录
current_working_directory = os.getcwd()
print("New current working directory:", current_working_directory)

def run(save_loc="BA_20spin/eco_1"):
